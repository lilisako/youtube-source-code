<template>
  <div>
    <!-- header -->
    <div class="flex justify-between py-2 px-4 bg-white sticky top-0 z-10">
      <div>
    ...
    <div class="grid grid-cols-4 gap-4 px-4">
      <div class="flex items-center justify-between border-2 border-black rounded-lg px-2 py-2">
      ...
      <div class="flex items-center justify-between border-2 border-black rounded-lg px-2 py-2">
        <p class="font-bold">Things To Do</p>
        <svg viewBox="0 0 24 24"  class="w-8 h-8"><circle cx="12" cy="8.5" r="1"></circle><circle cx="12" cy="12" r="1"></circle><circle cx="12" cy="15.5" r="1"></circle><path d="M20 6.5V8c-1.5.7-2.5 2.3-2.5 4 0 1.8 1 3.3 2.5 4v1.5H4V16c1.5-.7 2.5-2.3 2.5-4 0-1.8-1-3.3-2.5-4V6.5h16m2-2H2v5c1.4 0 2.5 1.1 2.5 2.5S3.4 14.5 2 14.5v5h20v-5c-1.4 0-2.5-1.1-2.5-2.5s1.1-2.5 2.5-2.5v-5z"></path></svg>
      </div>
      <div class="flex items-center justify-between border-2 border-black rounded-lg px-2 py-2">
      ...
      <div class="flex items-center justify-between border-2 border-black rounded-lg px-2 py-2">
        <p class="font-bold">Travel Forums</p>
        <svg viewBox="0 0 24 24"  class="w-8 h-8"><path d="M2 21.257h2.118l3.271-3h10.604l.02-11.513H2v14.513zM4 8.744h12.009l-.013 7.512H6.61L4 18.65V8.744z"></path><path d="M7.004 2.743v2h12.995v8.512H22V2.743z"></path></svg>
      </div>
      <div class="flex items-center justify-between border-2 border-black rounded-lg px-2 py-2">
      ...
      <div class="flex items-center justify-between border-2 border-black rounded-lg px-2 py-2">
        ...
        <svg viewBox="0 0 24 24"  class="w-8 h-8"><circle cx="4.5" cy="11.9" r="2.5"></circle><circle cx="19.5" cy="11.9" r="2.5"></circle><circle cx="12" cy="11.9" r="2.5"></circle></svg>
      </div>
    </div>
    <!-- category -->
    <!-- search -->
    <div class="px-4 py-4">
      <div class="relative bg-yellow-400">
        ...
        <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex h-16 w-2/3 bg-white rounded-xl items-center">
          <svg viewBox="0 0 24 24" class="w-6 h-6 ml-4"><path d="M22 20.514l-5.517-5.519a8.023 8.023 0 001.674-4.904c0-4.455-3.624-8.079-8.079-8.079C5.624 2.012 2 5.636 2 10.091s3.624 8.079 8.079 8.079a8.03 8.03 0 004.933-1.695l5.512 5.514L22 20.514zm-11.921-4.431c-3.305 0-5.993-2.688-5.993-5.992s2.688-5.992 5.993-5.992a6 6 0 015.992 5.992 6 6 0 01-5.992 5.992z"></path></svg>
          <p class="text-gray-400 text-xl pl-2">Where to?</p>
        </div>
      </div>
    </div>
    <!-- search -->
    ...
    <div class="px-4 py-8">
      ...
      <div class="flex">
        ...
        <div class="mx-2">
          ...
          <div class="w-72">
            ...
            <div class="flex items-center">
              ...
              <p class="text-gray-500 text-sm">597</p>
            </div>
            <div class="font-bold">from $58 per adult</div>
          </div>
        </div>
        <!-- section -->
        <!-- section -->
        <div class="mx-2">
          <div class="relative h-72 w-72">
            <img class="h-72 w-72" src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1d/d2/4c/ec/cappadocia-hot-air-balloon.jpg?w=300&h=-1&s=1" />
            <div class="rounded-full bg-white absolute top-2 right-2 p-2">
              <svg viewBox="0 0 24 24" class="w-6 h-6"><path d="M12.001 20.729s-6.741-5.85-8.485-8.003c-2.055-2.541-2.018-5.837.089-7.836a5.928 5.928 0 014.104-1.618c1.548 0 3.005.575 4.104 1.618l.174.165.162-.155a5.93 5.93 0 014.104-1.618c1.548 0 3.005.574 4.104 1.618 2.158 2.049 2.192 5.273.084 7.841-1.755 2.139-8.44 7.988-8.44 7.988zM7.709 5.271a3.935 3.935 0 00-2.727 1.068c-1.578 1.498-1.06 3.708.088 5.128 1.306 1.613 5.333 5.204 6.925 6.605 1.583-1.404 5.58-4.993 6.899-6.601 1.195-1.455 1.685-3.603.085-5.122-.726-.689-1.694-1.069-2.728-1.069s-2.001.38-2.728 1.069l-1.539 1.462-1.551-1.473a3.925 3.925 0 00-2.724-1.067z"></path></svg>
            </div>
            <div class="absolute bottom-2 left-2 bg-yellow-500 text-center rounded-xl p-1">
          ...
          <div class="w-72">
            <p class="font-bold">Cappadocia Hot Air Balloon Flight</p>
            <div class="flex items-center">
              ...
              <p class="text-gray-500 text-sm">467</p>
            </div>
            <div class="font-bold">from $113 per adult</div>
          </div>
        </div>
        <!-- section -->
        <!-- section -->
        <div class="mx-2">
          <div class="relative h-72 w-72">
            <img class="h-72 w-72" src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/08/99/c0/5d/surfer-factory.jpg?w=300&h=300&s=1" />
            <div class="rounded-full bg-white absolute top-2 right-2 p-2">
              <svg viewBox="0 0 24 24" class="w-6 h-6"><path d="M12.001 20.729s-6.741-5.85-8.485-8.003c-2.055-2.541-2.018-5.837.089-7.836a5.928 5.928 0 014.104-1.618c1.548 0 3.005.575 4.104 1.618l.174.165.162-.155a5.93 5.93 0 014.104-1.618c1.548 0 3.005.574 4.104 1.618 2.158 2.049 2.192 5.273.084 7.841-1.755 2.139-8.44 7.988-8.44 7.988zM7.709 5.271a3.935 3.935 0 00-2.727 1.068c-1.578 1.498-1.06 3.708.088 5.128 1.306 1.613 5.333 5.204 6.925 6.605 1.583-1.404 5.58-4.993 6.899-6.601 1.195-1.455 1.685-3.603.085-5.122-.726-.689-1.694-1.069-2.728-1.069s-2.001.38-2.728 1.069l-1.539 1.462-1.551-1.473a3.925 3.925 0 00-2.724-1.067z"></path></svg>
            </div>
            <div class="absolute bottom-2 left-2 bg-yellow-500 text-center rounded-xl p-1">
          ...
          <div class="w-72">
            <p class="font-bold">Surf Lessons with Pro Team in Jacó</p>
            <div class="flex items-center">
              <svg viewBox="0 0 128 24" class="text-green-500 fill-current" width="68" height="12"><path d="M 12 0C5.388 0 0 5.388 0 12s5.388 12 12 12 12-5.38 12-12c0-6.612-5.38-12-12-12z" transform=""></path><path d="M 12 0C5.388 0 0 5.388 0 12s5.388 12 12 12 12-5.38 12-12c0-6.612-5.38-12-12-12z" transform="translate(26 0)"></path><path d="M 12 0C5.388 0 0 5.388 0 12s5.388 12 12 12 12-5.38 12-12c0-6.612-5.38-12-12-12z" transform="translate(52 0)"></path><path d="M 12 0C5.388 0 0 5.388 0 12s5.388 12 12 12 12-5.38 12-12c0-6.612-5.38-12-12-12z" transform="translate(78 0)"></path><path d="M 12 0C5.388 0 0 5.388 0 12s5.388 12 12 12 12-5.38 12-12c0-6.612-5.38-12-12-12z" transform="translate(104 0)"></path></svg>
              <p class="text-gray-500 text-sm">160</p>
            </div>
            <div class="font-bold">from $77 per adult</div>
          </div>
        </div>
        <!-- section -->
        <!-- section -->
        <div class="mx-2">
          <div class="relative h-72 w-72">
            <img class="h-72 w-72" src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1b/91/0c/10/caption.jpg?w=300&h=300&s=1" />
            <div class="rounded-full bg-white absolute top-2 right-2 p-2">
              <svg viewBox="0 0 24 24" class="w-6 h-6"><path d="M12.001 20.729s-6.741-5.85-8.485-8.003c-2.055-2.541-2.018-5.837.089-7.836a5.928 5.928 0 014.104-1.618c1.548 0 3.005.575 4.104 1.618l.174.165.162-.155a5.93 5.93 0 014.104-1.618c1.548 0 3.005.574 4.104 1.618 2.158 2.049 2.192 5.273.084 7.841-1.755 2.139-8.44 7.988-8.44 7.988zM7.709 5.271a3.935 3.935 0 00-2.727 1.068c-1.578 1.498-1.06 3.708.088 5.128 1.306 1.613 5.333 5.204 6.925 6.605 1.583-1.404 5.58-4.993 6.899-6.601 1.195-1.455 1.685-3.603.085-5.122-.726-.689-1.694-1.069-2.728-1.069s-2.001.38-2.728 1.069l-1.539 1.462-1.551-1.473a3.925 3.925 0 00-2.724-1.067z"></path></svg>
            </div>
            <div class="absolute bottom-2 left-2 bg-yellow-500 text-center rounded-xl p-1">
          ...
          <div class="w-72">
            <p class="font-bold">Chichen Itza Sunrise and Cenote Ik Kil from Cancun</p>
            <div class="flex items-center">
              <svg viewBox="0 0 128 24" class="text-green-500 fill-current" width="68" height="12"><path d="M 12 0C5.388 0 0 5.388 0 12s5.388 12 12 12 12-5.38 12-12c0-6.612-5.38-12-12-12z" transform=""></path><path d="M 12 0C5.388 0 0 5.388 0 12s5.388 12 12 12 12-5.38 12-12c0-6.612-5.38-12-12-12z" transform="translate(26 0)"></path><path d="M 12 0C5.388 0 0 5.388 0 12s5.388 12 12 12 12-5.38 12-12c0-6.612-5.38-12-12-12z" transform="translate(52 0)"></path><path d="M 12 0C5.388 0 0 5.388 0 12s5.388 12 12 12 12-5.38 12-12c0-6.612-5.38-12-12-12z" transform="translate(78 0)"></path><path d="M 12 0C5.388 0 0 5.388 0 12s5.388 12 12 12 12-5.38 12-12c0-6.612-5.38-12-12-12z" transform="translate(104 0)"></path></svg>
              <p class="text-gray-500 text-sm">148</p>
            </div>
            <div class="font-bold">from $334 per adult</div>
          </div>
        </div>
        <!-- section -->
      </div>
